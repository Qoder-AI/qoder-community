...
version: 1.0.0
description: 使用 Sora 2 Pro 专业版模型，生成电影级画质、长时长的超高清文生视频或图生视频。
metadata: {"clawdbot":{"emoji":"🤖","requires":{"bins":["npm","npx"]},"install":"npm install -g @dlazy/cli"},"openclaw":{"systemPrompt":"当调用此技能时，可以使用 dlazy sora-2-pro -h 查看帮助信息。"}}
---

# dlazy-sora-2-pro

使用 Sora 2 Pro 专业版模型，生成电影级画质、长时长的超高清文生视频或图生视频。
...
```bash
# 基础调用：
dlazy sora-2-pro --prompt '提示词内容' --image '/path/to/image.png'

# 复杂调用：
dlazy sora-2-pro --prompt '提示词内容' --image 'https://oss.dlazy.com/image.png'
```
